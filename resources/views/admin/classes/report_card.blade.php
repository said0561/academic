...
@section('content')
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <div class="mb-3 border-bottom pb-2">
                <div class="d-flex align-items-center justify-content-center mb-2">
                    ...
                    <div class="text-center">
                        ...
                        <p class="small mb-0 text-muted">P.O BOX 67 SHINYANGA - TEL 255 699 617 660</p>
                                                    <p class="small mb-0 fw-semibold" style="color:#118a3b;">
                                PUPILS' ACADEMIC PROGRESS REPORT CARD
                            </p>
                ...
                <div class="d-flex justify-content-center">
                    <div style="height: 4px; width: 80px; background: linear-gradient(90deg,#b93173,#118a3b); border-radius: 999px;"></div>
                </div>
            </div>
            ...
            <div class="row small mb-3">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="mb-1">
                        <strong>Exam:</strong>
                        @if($selectedExam)
                            {{ $selectedExam->name }} (T{{ $selectedExam->term }}, {{ $selectedExam->year }})
                        @else
            ...
            {{-- SIGNATURES AREA – COLUMNS MBILI --}}
            <div class="row small mt-3">
                <div class="col-md-6 mb-3">
                    <p class="mb-1"><strong>Class Teacher:</strong> ____________________________</p>
                    <p class="mb-1"><strong>Signature:</strong> _______________________________</p>

                                        <p class="mb-1"><strong>Parent / Guardian:</strong> _______________________</p>
                    <p class="mb-1"><strong>Signature:</strong> _______________________________</p>
                </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 actions-print-area">
                <a href="{{ route('admin.classes.exam-report', [$class->id, 'exam_id' => $selectedExamId]) }}"
                   class="btn btn-outline-secondary btn-sm">
                    &larr; Back to Class Report
                </a>
    ...
    /* Force colors to be preserved on print */
    @media print {
        * {
